...
title: SST26 SQI flash driver - Flash read write in SQI mode 
has_children: false
has_toc: false
---
...
# SST26 SQI flash driver - Flash read write in SQI mode

This example application shows how to use the SST26 driver to perform block operations on the On-Board SST26 Flash memory in SQI mode.
