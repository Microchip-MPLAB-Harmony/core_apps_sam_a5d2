...
{"0": {
    ...
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Setting up the board . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Reset the board to run the application | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | One EEPROM 3 Click board | mikroBUS Xplained Pro board | . Setting up the board . | Install the EEPROM 3 Click board on to the mikroBUS Xplained Pro board | Connect the mikroBUS Xplained Pro board to the EXT1 header | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | LED is turned ON when the data read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "Memory driver asynchronous -  MX25L QSPI and AT25DF SPI flash read write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | LED is turned ON when the data read from each media matches with the data written in them | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the board . | Insert the SD card into SDMMC1 slot on the board | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | I/O1 Xplained Pro Extension Kit | Micro-SD card | . Setting up the board . | Connect the I/O1 Xplained Pro Extension Kit to the EXT1 header | Insert microSD card on the I/O1 Xplained Pro Extension Kit | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the read data from the SD card matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SPI Driver asynchronous - multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | Two EEPROM 4 Click boards | Two mikroBUS Xplained Pro boards | . Setting up the board . | Install EEPROM 4 Click boards on to the mikroBUS Xplained Pro boards | Connect mikroBUS Xplained Pro on to the “EXT1” and “EXT2” headers | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "SPI Driver asynchronous - multi client",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED turns ON when the data read from the EEPROMs matches with the data written to the EEPROMs. | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Setting up the board . | Use jumper wire to Connect “Pin 16 of EXT1 header” to “Pin 17 of EXT1 header” . | SPI1 MOSI signal is mapped to PD26 that is routed to “Pin 16 of EXT1 header” | SPI1 MISO signal is mapped to PD27 that is routed to “Pin 17 of EXT1 header” | . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | EEPROM 4 Click board | mikroBUS Xplained Pro board | . Setting up the board . | Install an EEPROM 4 Click board on to the mikroBUS Xplained Pro board | Connect mikroBUS Xplained Pro board to the EXT1 header | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the value read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FreeRTOS Task Notification",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Reset the board to run the application | The LED toggles on success for every 500ms | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Blue) | . |   |   | . ",
    ...
    "doc": "USART driver asynchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . | sam_a5d27_som1_ek.X | SAMA5D27-SOM1-EK1 | . |   |   | . Setting up SAMA5D27-SOM1-EK1 . Setting up the board . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Setting up the board . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | USB UART CLICK board | . Setting up the board . | Connect USB UART CLICK board to the evaluation kit using the pin connections described below: . | SAM A5D2 Xplained Ultra board Pins | USB UART Click board Pins | . | F0_TXD, J22 connector | RX | . | F0_RXD, J22 connector | TX | . | PIN 20, XPRO EXT2 connector | 3.3V | . | PIN 19, XPRO EXT2 connector | GND | . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "USART driver asynchronous - USART multi instance",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer for both ports | Connect to the EDBG/Jlink Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Type a character and observe the output on the two consoles as shown below: . | If success the character typed echoes back and an LED toggles on each time the character is echoed | Console 1 | . | Console 2 | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . | sam_a5d27_som1_ek_freertos.X | SAMA5D27-SOM1-EK1 | . |   |   | . Setting up SAMA5D27-SOM1-EK1 . Setting up the board . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Setting up the board . | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "USART driver synchronous - USART multi instance",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer for both ports | Connect to the EDBG/Jlink Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Type ten characters and observe the output on the two consoles as shown below: . | If success, when ten characters are typed it will be echoed back on the console and LED is toggled every time the characters are echoed | Console 1 | . | Console 2 | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem throughput using eMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the board . | Insert the SD card into SDMMC slot on the board | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | Jumper JP9 (BOOT_DIS) should be open | . NOTE: To run this demo successfully, on board eMMC device should have a valid FAT partition . ",
    ...
    "doc": "FAT filesystem using EMMC media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the SD Card . | Create a new JPEG file in the SD Card with name FILE_TOO_LONG_NAME_EXAMPLE_123.JPG | . Setting up the board . | Insert the SD card into SDMMC slot on the board | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | Jumper JP9 (BOOT_DIS) should be open | . ",
    ...
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . | sam_a5d27_som1_ek_freertos.X | SAMA5D27-SOM1-EK1 | . |   |   | . Setting up SAMA5D27-SOM1-EK1 . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the SD Card . | Create a new JPEG file in the SD Card with name FILE_TOO_LONG_NAME_EXAMPLE_123.JPG | . Setting up the board . | Insert the SD card into SDMMC slot | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the SD Card . | Create a new JPEG file in the SD Card with name FILE_TOO_LONG_NAME_EXAMPLE_123.JPG | . Setting up the board . | Insert the SD card into SDMMC slot | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON if there was no error during creating the directory and copying the file into it | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D27-SOM1-EK1 | D5(Green) | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X | SAMA5D2 Xplained Ultra Evaluation Kit | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Addtional hardware required . | SD Card with FAT32 file system . | The SD Card should have atleast 10MB of free space for the demo to work | . | . Setting up the board . | Insert the SD card into SDMMC slot on the board | Short jumper JP2 (DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "FAT filesystem using SPI flash media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON if data has successfully been written and read back from file “newfile.txt” | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem using SQI Flash Media",
    "title": "FAT filesystem using SQI Flash Media",
    "content": "This application shows an example of using the MPLAB Harmony File System to access SQI based flash media. The SAMA5D2 Xplained Ultra Evaluation Kit has the MX25L flash memory while the SAMA5D27-SOM1-EK1 and the SAMA5D27-WLSOM1-EK1 have the SST26 flash media. ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/fs/sqi_flash_fat/readme.html#fat-filesystem-using-sqi-flash-media",
    "relUrl": "/apps/fs/sqi_flash_fat/readme.html#fat-filesystem-using-sqi-flash-media"
  },"179": {
    "doc": "FAT filesystem using SQI Flash Media",
    "title": "Description",
    "content": "File System Operations on the On-Board SQI Flash Memory . | Performs a SYS_FS_FormatDisk | Opens a newfile.txt on the flash memory | Write and reads back 4KB of data on newfile.txt | Verifies the Data Read back | . File system layer uses the following components . | One instance of the Memory driver is used to communicate with the On-Board SQI Flash memory | . ",
    ...
    "doc": "FAT filesystem using SQI Flash Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_a5d2_xult.X sam_a5d2_xult_freertos.X | SAMA5D2 Xplained Ultra Evaluation Kit | . | sam_a5d27_som1_ek_freertos.X | SAMA5D27-SOM1-EK1 | . | sam_a5d27_wlsom1_ek1_freertos.X | SAMA5D27-WLSOM1-EK1 | . |   |   | . Setting up SAMA5D2 Xplained Ultra Evaluation Kit . Setting up the board . | Short jumper JP2 (DEBUG_DIS) | Connect a USB to UART FTDI cable to J1 (DEBUG) to open a serial terminal | Connecting a micro-USB cable to either J23 or J14 powers the board | . Setting up SAMA5D27-SOM1-EK1 Evaluation Kit . Setting up the board . | Connecting a micro-USB cable to J10 both powers the board as well as provides a virtal COM port to open a serial terminal | . Setting up SAMA5D27-WLSOM1-EK1 Evaluation Kit . Setting up the board . | Connect a USB to UART FTDI cable to J26 (DEBUG FTDI) to open a serial terminal | Connecting a micro-USB cable to J10 powers the board | Press the SW3 (nSTART_SOM) button to power the ATSAMA5D27-WLSOM1 System-On-Module | . ",
    ...
    "doc": "FAT filesystem using SQI Flash Media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON if data has successfully been written and read back from file “newfile.txt” | . Refer to the following table for LED name: . | Board | LED Name | . | SAMA5D2 Xplained Ultra Evaluation Kit | RGB LED(Green) | . | SAMA5D27-SOM1-EK1 Evaluation Kit | D5 (Green) | . | SAMA5D27-WLSOM1-EK1 Evaluation Kit | LD1 (Green) | . |   |   | . |   |   | . ",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap.html#using-at91boostrap-loader-with-harmony3-mpu-applications",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap.html#rundebug-mpu-applications-using-mplabx",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap.html#boot-to-application-using-sd-card",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap_build.html#building-at91bootstrap-project-using-mplabx",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap_build.html#configure-compiler",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#configure-compiler"
  },"205": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Configure target",
    "content": ". | Open project properties window, and choose “Kconfig” option to configure the build target: . | Click on “LOAD” button and navigate to the configs folder inside at91bootstrap.X directory. You need to choose the default configuration file(defconfig) based on what you need the at91boostrap to do . Debug/Run application from within MPLABx . | Load {evaluation_kit}_bkpt_none_defconfig. For example, on SAMA5D2 Xplained Evaluation Kit, select sama5d2_xplained_bkptnone_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAMA5D2” and the primary operation is selected as “Configure and Stop” . | . Load and Run application from an SD card . | Load {evaluation_kit}sd_uboot_defconfig. For example, on SAMA5D2 Xplained Evaluation Kit, select sama5d2_xplainedsd_uboot_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAMA5D2” and the primary operation is selected as “Load and launch next software” . | Edit the Option “Next Software Image File Name” from u-boot.bin to harmony.bin . | . | . ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap_build.html#configure-target",
    ...
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap_build.html#build-target",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#build-target"
  },"207": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Building AT91Bootstrap project using MPLABx",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/apps/docs/readme_bootstrap_build.html",
    ...
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAMA5D2 family  v3.4.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAMA5D2 Xplained Ultra Evaluation Kit | 39 | . | SAMA5D27-SOM1-EK1 | 5 | . | ATSAMA5D27-WLSOM1 Evaluation Kit | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/release_notes.html#harmony-3-peripheral-library-application-examples-for-sama5d2-family--v340",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sama5d2-family--v340"
  },"210": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAMA5D2 family  v3.3.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | IAR applications | . | SAMA5D2 Xplained Ultra Evaluation Kit | 39 | 36 | . | SAMA5D27-SOM1-EK1 | 5 | 0 | . | ATSAMA5D27-WLSOM1 Evaluation Kit | 1 | 0 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | IAR Embedded workbench for ARM v9.10 or above | . ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/release_notes.html#harmony-3-peripheral-library-application-examples-for-sama5d2-family--v330",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sama5d2-family--v330"
  },"211": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM A5D2 family  v3.2.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | IAR applications | . | SAMA5D2 Xplained Ultra Evaluation Kit | 39 | 36 | . | SAMA5D27-SOM1-EK1 | 5 | 0 | . New Features . | All MPLAB X applications are updated to work with both MHC and MCC tools | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | IAR Embedded workbench for ARM v9.10 or above | . ",
    "url": "http://localhost:4000/core_apps_sam_a5d2/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-a5d2-family--v320",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-a5d2-family--v320"
  },"212": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM A5D2 family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | IAR applications | . | SAMA5D2 Xplained Ultra Evaluation Kit | 39 | 36 | . | SAMA5D27-SOM1-EK1 | 4 | 0 | . New Features . | None | . Known Issues . | SAMA5D2 family: SAMA5D2_DFP v1.5.53 or higher is required to correctly program and debug the application from within MPLAB X 5.45 | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | IAR Embedded workbench for ARM v8.50 or above | . ",
...
var repo_name = "core_apps_sam_a5d2";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for SAM A5D2 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_sam_a5d2/assets/css/just-the-docs-' + theme + '.css');
}
